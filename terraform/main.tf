...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "Quality Inspector • BOM (Discrete)"
    environment = "production"
    Name = "agentbridge-quality-inspector---bom--discrete-"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-quality-inspector---bom--discrete--igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-quality-inspector---bom--discrete--public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-quality-inspector---bom--discrete--rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-quality-inspector---bom--discrete--"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-quality-inspector---bom--discrete--sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-quality-inspector---bom--discrete-"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-quality-inspector---bom--discrete--eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-quality-inspector---bom--discrete--data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-quality-inspector---bom--discrete--bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-quality-inspector---bom--discrete--ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-quality-inspector---bom--discrete--ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-quality-inspector---bom--discrete--flow"
